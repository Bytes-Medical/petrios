        ...
        <div className="overflow-x-auto border border-gray-300 bg-white">
          <table className="w-full min-w-[760px] border-collapse text-left text-xs">
            ...
            <tbody>
              ...
              <ServiceRow service={config.aiProvider} purpose="Optional LLM, private learning-document processing, provider-hosted authoritative web research, and text-to-speech" data="Purpose-limited session metadata, assistant messages, processed feedback, private PDF/DOCX/PPTX contents sent on moderator recap generation, document-derived search queries, public result URLs/titles, recap scripts, and speech text" status={config.aiEnabled ? 'Enabled' : 'Disabled'} />
